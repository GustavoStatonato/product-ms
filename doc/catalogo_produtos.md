...
Neste microserviço deve ser possí­vel criar, alterar, visualizar e excluir um determinado produto, além de visualizar a lista de produtos atuais disponí­veis. Também deve ser possí­vel realizar a busca de produtos filtrando por *name, description e price*.
...
Os testes unitários serão avaliados e a cobertura devera ter uma margem de 80% de cobertura contemplada.
Obs: Utilizar o plugin JaCoCo para avaliar cobertura de teste.

## Banco de Dados

O Banco de dados a ser utilizado deverá ser o mysql.
**Diferencial: Que o banco de dados suba em um ambiente docker  e que seja inicializado através de um arquivo docker-compose.yml** 
...
A validação dos endpoints e sua correta funcionalidade será feita manualmente. Logo, é importante que você defina a porta do serviço como sendo 8085, ficando a base url então: http://localhost:8085
